...
- Name: 12-admin-users.spec.ts >> Admin Users page >> Edit User modal has Cancel and Save buttons
- Location: tests\e2e\12-admin-users.spec.ts:65:7
...
Locator: getByRole('dialog').getByRole('button', { name: /cancel/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog').getByRole('button', { name: /cancel/i })
